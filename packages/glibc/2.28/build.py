...
def build(source_path, build_path, install_path, targets):
    package_url = 'https://ftp.gnu.org/gnu/glibc/glibc-2.28.tar.xz'
    ...
    def _build():
        ...
        if not os.path.exists(makefile_path):
            ...
            configure_proc = subprocess.Popen('../{}/configure --prefix=$REZ_BUILD_INSTALL_PATH --disable-werror CFLAGS="-O3"'.format(folder_name), shell=True)
